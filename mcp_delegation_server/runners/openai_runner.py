...
class OpenAIRunner(BaseRunner):
    """Runner adapter for OpenAI models (GPT-4o, GPT-4o-mini, o3-mini, etc.) via official SDK."""
    ...
    def _get_api_key(self) -> str | None:
        ...
        env_var_name = self.config.api_key_env or "OPENAI_API_KEY"
    ...
    async def execute(
        ...
        """Execute a prompt/task using OpenAI Chat Completions API and return normalized RunnerResult."""
        ...
        try:
            ...
            return RunnerResult(
                ...
                estimated_cost_usd=0.0,
                success=False,
                error_message=f"Unexpected error executing OpenAI runner: {type(e).__name__}: {str(e)}",
            )
